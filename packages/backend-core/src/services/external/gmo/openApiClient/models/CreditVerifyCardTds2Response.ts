...
/**
 * クレカ払い 有効性確認(/credit/verifyCard)の3Dセキュアリダイレクト時のレスポンスパラメーター
 */
export type CreditVerifyCardTds2Response = {
  /**
   ...
   * - <span class="mp-oas-code">status</span>フィールドは必ず<span class="mp-oas-code">AUTHENTICATED</span>です。
