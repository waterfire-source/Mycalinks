 ...
 */
export type OrderUpdateResponseCredit = {
  /**
   * 取引参照情報
   *
   */
  ...
  /**
   * カード支払い結果情報
   * 金額変更時は元の取引が3Dセキュア認証済であっても、3Dセキュア認証の利用有無<span class="mp-oas-code">useTds2</span>は必ず<span class="mp-oas-code">false</span>です。
   *
   */
