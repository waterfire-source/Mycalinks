...
-- AlterTable
ALTER TABLE `Account_Group` ADD COLUMN `list_original_pack` TINYINT UNSIGNED NOT NULL DEFAULT false,
    ADD COLUMN `list_purchase_table` TINYINT UNSIGNED NOT NULL DEFAULT false,
