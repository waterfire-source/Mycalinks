/*
  ...
  - You are about to drop the column `appraisal_company_name` on the `Appraisal` table. All the data in the column will be lost.
  - You are about to drop the column `appraisal_number` on the `Appraisal_Product` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `Appraisal` DROP COLUMN `appraisal_company_name`,
    ADD COLUMN `appraisal_company_id` INTEGER UNSIGNED NULL,
...
-- AlterTable
ALTER TABLE `Appraisal_Product` DROP COLUMN `appraisal_number`;
...
-- AddForeignKey
ALTER TABLE `Appraisal` ADD CONSTRAINT `Appraisal_appraisal_company_id_fkey` FOREIGN KEY (`appraisal_company_id`) REFERENCES `Appraisal_Company`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
