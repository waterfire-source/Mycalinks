...
-- AlterTable
ALTER TABLE `Inventory_Products` ADD COLUMN `average_wholesale_price` INTEGER NULL,
    ADD COLUMN `maximum_wholesale_price` INTEGER NULL,
    ADD COLUMN `minimum_wholesale_price` INTEGER NULL,
    ADD COLUMN `total_wholesale_price` INTEGER NULL;
...
-- AlterTable
ALTER TABLE `Product` ADD COLUMN `total_wholesale_price` INTEGER NULL,
    MODIFY `created_at` TIMESTAMP(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(),
    MODIFY `updated_at` TIMESTAMP(0) NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
