...
-- CreateIndex
CREATE INDEX `Transaction_Cart_reservation_reception_product_id_for_deposi_idx` ON `Transaction_Cart`(`reservation_reception_product_id_for_deposit`, `transaction_id`);

-- CreateIndex
CREATE INDEX `Transaction_Cart_reservation_reception_product_id_for_receiv_idx` ON `Transaction_Cart`(`reservation_reception_product_id_for_receive`, `transaction_id`);
