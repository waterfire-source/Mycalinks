...
ALTER TABLE `Transaction`
    MODIFY COLUMN `total_sale_price` INTEGER GENERATED ALWAYS AS (total_price - total_reservation_price) STORED,
...
ALTER TABLE `Transaction_Cart`
    ...
    MODIFY `total_sale_unit_price` INTEGER GENERATED ALWAYS AS (unit_price + total_discount_price) STORED;
