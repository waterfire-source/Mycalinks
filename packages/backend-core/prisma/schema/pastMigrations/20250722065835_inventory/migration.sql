...
-- AlterTable
ALTER TABLE `Inventory` ADD COLUMN `total_item_wholesale_price` BIGINT NULL,
    MODIFY `created_at` TIMESTAMP(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(),
    MODIFY `updated_at` TIMESTAMP(0) NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP();

-- AlterTable
ALTER TABLE `Inventory_Products` ADD COLUMN `input_total_wholesale_price` INTEGER NULL;
