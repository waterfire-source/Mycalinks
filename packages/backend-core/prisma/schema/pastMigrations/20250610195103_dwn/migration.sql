/*
  ...
  - The primary key for the `Dim_Transaction_Customer` table will be changed. If it partially fails, the table could be left without primary key constraint.
  - You are about to drop the column `cart_id` on the `Dim_Transaction_Customer` table. All the data in the column will be lost.
  - You are about to drop the column `store_id` on the `Dim_Transaction_Customer` table. All the data in the column will be lost.
  - You are about to drop the column `target_day` on the `Dim_Transaction_Customer` table. All the data in the column will be lost.
  - Added the required column `transaction_id` to the `Dim_Transaction_Customer` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `Dim_Transaction_Customer` DROP PRIMARY KEY,
    DROP COLUMN `cart_id`,
    DROP COLUMN `store_id`,
    DROP COLUMN `target_day`,
