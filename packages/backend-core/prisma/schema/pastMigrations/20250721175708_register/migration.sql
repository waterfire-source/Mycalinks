...
-- AlterTable
ALTER TABLE `Register_Cash_History` MODIFY `source_kind` ENUM('transaction_buy', 'transaction_buy_return', 'transaction_sell', 'transaction_sell_return', 'reservation_deposit', 'reservation_deposit_return', 'import', 'export', 'adjust', 'sales') NOT NULL,
    MODIFY `datetime` TIMESTAMP(0) NOT NULL DEFAULT CURRENT_TIMESTAMP();

-- AlterTable
ALTER TABLE `Register_Settlement` ADD COLUMN `reservation_deposit_return_total` INTEGER NOT NULL DEFAULT 0,
    ADD COLUMN `reservation_deposit_total` INTEGER NOT NULL DEFAULT 0,
    MODIFY `created_at` TIMESTAMP(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(),
