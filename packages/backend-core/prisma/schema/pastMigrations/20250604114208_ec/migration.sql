/*
  ...
  - You are about to alter the column `payment_info` on the `Ec_Order` table. The data in that column could be lost. The data in that column will be cast from `VarChar(191)` to `Json`.
