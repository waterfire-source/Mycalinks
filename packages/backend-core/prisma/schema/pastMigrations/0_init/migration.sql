...
CREATE TABLE `Register_Cash_History` (
    ...
    UNIQUE INDEX `Register_Cash_History_register_id_source_kind_datetime_key`(`register_id`, `source_kind`, `datetime`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Store` (
    `id` INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
    `code` VARCHAR(32) NOT NULL DEFAULT concat(lpad(hex(unix_timestamp(now(3)) * 1000), 12, '0'),'7',substr(hex(random_bytes(2)), 2),hex(floor(rand() * 4 + 8)),substr(hex(random_bytes(8)), 2)),
    `display_name` VARCHAR(191) NULL,
...
CREATE TABLE `Ec_Order_Payment` (
    ...
    `service` ENUM('GMO', 'ORIGINAL') NOT NULL,
...
CREATE TABLE `Ec_Order_Cart_Store` (
    `order_id` INTEGER UNSIGNED NOT NULL,
    `store_id` INTEGER UNSIGNED NOT NULL,
    `code` VARCHAR(30) NOT NULL DEFAULT concat(lpad(hex(unix_timestamp(now(3)) * 1000), 12, '0'),substr(hex(random_bytes(2)), 2)),
...
CREATE TABLE `Item` (
    ...
    INDEX `Item_myca_item_id_idx`(`myca_item_id`),
...
CREATE TABLE `Item_Category` (
    ...
    `display_name` VARCHAR(191) NOT NULL,
    `store_id` INTEGER UNSIGNED NOT NULL,
    `handle` ENUM('CARD', 'BOX', 'ORIGINAL_PACK', 'LUCKY_BAG', 'BUNDLE', 'STORAGE', 'PURCHASE_GUARANTEE', 'OTHER') NULL,
...
CREATE TABLE `Condition` (
    ...
    UNIQUE INDEX `Condition_store_id_handle_key`(`store_id`, `handle`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Condition_Option` (
    ...
    `display_name` VARCHAR(191) NULL,
    `description` TEXT NULL,
    `auto_price_adjustment` VARCHAR(191) NULL,
    `auto_sell_price_adjustment_round_rule` ENUM('up', 'down', 'round') NOT NULL,
    `auto_buy_price_adjustment_round_rule` ENUM('up', 'down', 'round') NOT NULL,
    `auto_sell_price_adjustment_round_rank` INTEGER NOT NULL,
    `auto_buy_price_adjustment_round_rank` INTEGER NOT NULL,

    UNIQUE INDEX `Condition_Option_condition_id_handle_key`(`condition_id`, `handle`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- CreateTable
CREATE TABLE `Item_Allowed_Condition` (
    `item_id` INTEGER UNSIGNED NOT NULL,
    `condition_id` INTEGER UNSIGNED NOT NULL,
...
CREATE TABLE `Stocking` (
    ...
    INDEX `Stocking_status_idx`(`status`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Product` (
    ...
    `wholesale_price` INTEGER NULL,
    `type` ENUM('BUNDLE', 'ORIGINAL_PACK', 'NORMAL') NOT NULL DEFAULT 'NORMAL',

    INDEX `Product_product_code_idx`(`product_code`),
    INDEX `Product_readonly_product_code_idx`(`readonly_product_code`),
    INDEX `Product_actual_sell_price_idx`(`actual_sell_price`),
    UNIQUE INDEX `Product_store_id_product_code_key`(`store_id`, `product_code`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Tag` (
    ...
    `display_name` VARCHAR(191) NOT NULL,
    `description` VARCHAR(191) NULL,
    `genre1` ENUM('appraisal_option', 'appraisal_number') NULL,
    `genre2` VARCHAR(191) NULL,
    `created_at` TIMESTAMP(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(),
    `updated_at` TIMESTAMP(0) NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),

    INDEX `Tag_genre1_genre2_idx`(`genre1`, `genre2`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Appraisal` (
    ...
    `appraisal_company_name` VARCHAR(191) NULL,
    `staff_account_id` INTEGER UNSIGNED NOT NULL,
...
CREATE TABLE `Appraisal_Product` (
    ...
    `product_id` INTEGER UNSIGNED NOT NULL,
    `appraisal_result_tag_id` INTEGER UNSIGNED NULL,
...
CREATE TABLE `Product_Condition` (
    ...
    PRIMARY KEY (`product_id`, `condition_option_id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Inventory` (
    ...
    `store_id` INTEGER UNSIGNED NOT NULL,
    `total_item_count` INTEGER NULL,
    `total_item_sell_price` INTEGER NULL,
    `total_stock_number` INTEGER NULL,
    `total_stock_sell_price` INTEGER NULL,
    `staff_account_id` INTEGER UNSIGNED NOT NULL,
    `description` VARCHAR(191) NULL,
...
CREATE TABLE `Transaction` (
    ...
    `previous_transaction_id` INTEGER UNSIGNED NULL,
    `created_at` TIMESTAMP(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(),
    `updated_at` TIMESTAMP(0) NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
    ...
    UNIQUE INDEX `Transaction_previous_transaction_id_key`(`previous_transaction_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Transaction_Cart` (
    ...
    `discount_price` INTEGER NOT NULL DEFAULT 0,
    `total_discount_price` INTEGER NOT NULL DEFAULT 0,
    `total_unit_price` INTEGER NOT NULL DEFAULT 0,
...
-- AddForeignKey
ALTER TABLE `Item_Price` ADD CONSTRAINT `Item_Price_item_id_fkey` FOREIGN KEY (`item_id`) REFERENCES `Item`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `Condition` ADD CONSTRAINT `Condition_store_id_fkey` FOREIGN KEY (`store_id`) REFERENCES `Store`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Condition_Option` ADD CONSTRAINT `Condition_Option_condition_id_fkey` FOREIGN KEY (`condition_id`) REFERENCES `Condition`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Item_Allowed_Condition` ADD CONSTRAINT `Item_Allowed_Condition_item_id_fkey` FOREIGN KEY (`item_id`) REFERENCES `Item`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Item_Allowed_Condition` ADD CONSTRAINT `Item_Allowed_Condition_condition_id_fkey` FOREIGN KEY (`condition_id`) REFERENCES `Condition`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `Tag` ADD CONSTRAINT `Tag_store_id_fkey` FOREIGN KEY (`store_id`) REFERENCES `Store`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `Appraisal_Product` ADD CONSTRAINT `Appraisal_Product_appraisal_result_tag_id_fkey` FOREIGN KEY (`appraisal_result_tag_id`) REFERENCES `Tag`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `Product_Condition` ADD CONSTRAINT `Product_Condition_product_id_fkey` FOREIGN KEY (`product_id`) REFERENCES `Product`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Product_Condition` ADD CONSTRAINT `Product_Condition_condition_option_id_fkey` FOREIGN KEY (`condition_option_id`) REFERENCES `Condition_Option`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `Transaction` ADD CONSTRAINT `Transaction_previous_transaction_id_fkey` FOREIGN KEY (`previous_transaction_id`) REFERENCES `Transaction`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
