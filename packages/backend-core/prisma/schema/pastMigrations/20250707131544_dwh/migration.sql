...
-- AlterTable
ALTER TABLE `Fact_Daily_Product` ADD COLUMN `management_number` VARCHAR(191) NULL,
    ADD COLUMN `specialty_display_name` VARCHAR(191) NULL,
    ADD COLUMN `specialty_id` INTEGER UNSIGNED NULL;

-- AlterTable
ALTER TABLE `Fact_Transaction_Product` ADD COLUMN `management_number` VARCHAR(191) NULL,
    ADD COLUMN `specialty_display_name` VARCHAR(191) NULL,
    ADD COLUMN `specialty_id` INTEGER UNSIGNED NULL;
...
-- CreateIndex
CREATE INDEX `Fact_Daily_Product_specialty_id_idx` ON `Fact_Daily_Product`(`specialty_id`);

-- CreateIndex
CREATE INDEX `Fact_Daily_Product_specialty_display_name_idx` ON `Fact_Daily_Product`(`specialty_display_name`);

-- CreateIndex
CREATE INDEX `Fact_Transaction_Product_specialty_id_idx` ON `Fact_Transaction_Product`(`specialty_id`);

-- CreateIndex
CREATE INDEX `Fact_Transaction_Product_specialty_display_name_idx` ON `Fact_Transaction_Product`(`specialty_display_name`);
