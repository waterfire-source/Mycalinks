...
-- CreateIndex
CREATE INDEX `Product_store_id_deleted_is_active_item_id_condition_option__idx` ON `Product`(`store_id`, `deleted`, `is_active`, `item_id`, `condition_option_id`, `stock_number`);