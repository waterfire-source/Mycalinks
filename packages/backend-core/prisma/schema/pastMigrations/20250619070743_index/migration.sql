-- DropForeignKey
ALTER TABLE `Item` DROP FOREIGN KEY `Item_genre_id_fkey`;

-- DropIndex
DROP INDEX `Item_genre_id_fkey` ON `Item`;
...
-- CreateIndex
CREATE INDEX `Item_Category_ec_enabled_id_idx` ON `Item_Category`(`ec_enabled`, `id`);

-- CreateIndex
CREATE INDEX `Item_Genre_ec_enabled_id_idx` ON `Item_Genre`(`ec_enabled`, `id`);
