...
-- AlterTable
ALTER TABLE `Purchase_Table_Item` ADD COLUMN `is_psa10` TINYINT UNSIGNED NOT NULL DEFAULT false,
    MODIFY `any_model_number` TINYINT UNSIGNED NOT NULL DEFAULT false;
