-- DropForeignKey
ALTER TABLE `Register_Cash_History` DROP FOREIGN KEY `Register_Cash_History_register_id_fkey`;

-- DropIndex
DROP INDEX `Register_Cash_History_register_id_source_kind_datetime_key` ON `Register_Cash_History`;
...
-- CreateIndex
CREATE INDEX `Register_Cash_History_register_id_source_kind_datetime_idx` ON `Register_Cash_History`(`register_id`, `source_kind`, `datetime`);