...
CREATE TABLE `Ec_Message_Center` (
    ...
    `order_cart_store_code` VARCHAR(30) NULL,
...
-- AddForeignKey
ALTER TABLE `Ec_Message_Center` ADD CONSTRAINT `Ec_Message_Center_order_cart_store_code_fkey` FOREIGN KEY (`order_cart_store_code`) REFERENCES `Ec_Order_Cart_Store`(`code`) ON DELETE CASCADE ON UPDATE CASCADE;
