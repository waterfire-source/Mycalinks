/*
  ...
  - You are about to drop the column `staff_barcode_timeout_minutes` on the `Corporation` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `Corporation` DROP COLUMN `staff_barcode_timeout_minutes`,
    MODIFY `square_available` TINYINT UNSIGNED NOT NULL DEFAULT false,
...
-- AlterTable
ALTER TABLE `Store` ADD COLUMN `staff_barcode_timeout_minutes` INTEGER NOT NULL DEFAULT 60,
