/*
  ...
  - A unique constraint covering the columns `[ochanoko_email]` on the table `Ec_Setting` will be added. If there are existing duplicate values, this will fail.
  - A unique constraint covering the columns `[ochanoko_account_id]` on the table `Ec_Setting` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX `Ec_Setting_ochanoko_email_key` ON `Ec_Setting`(`ochanoko_email`);

-- CreateIndex
CREATE UNIQUE INDEX `Ec_Setting_ochanoko_account_id_key` ON `Ec_Setting`(`ochanoko_account_id`);
