-- DropIndex
DROP INDEX `Store_mycalinks_ec_enabled_idx` ON `Store`;
...
-- CreateIndex
CREATE INDEX `Item_Category_Condition_Option_id_handle_idx` ON `Item_Category_Condition_Option`(`id`, `handle`);

-- CreateIndex
CREATE INDEX `Store_id_mycalinks_ec_enabled_idx` ON `Store`(`id`, `mycalinks_ec_enabled`);
