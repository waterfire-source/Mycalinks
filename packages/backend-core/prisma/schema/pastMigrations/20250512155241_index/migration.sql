...
-- CreateIndex
CREATE INDEX `Account_deleted_idx` ON `Account`(`deleted`);

-- CreateIndex
CREATE INDEX `App_Advertisement_deleted_idx` ON `App_Advertisement`(`deleted`);

-- CreateIndex
CREATE INDEX `Inventory_Shelf_is_deleted_idx` ON `Inventory_Shelf`(`is_deleted`);

-- CreateIndex
CREATE INDEX `Item_Category_deleted_hidden_idx` ON `Item_Category`(`deleted`, `hidden`);

-- CreateIndex
CREATE INDEX `Item_Category_Condition_Option_deleted_idx` ON `Item_Category_Condition_Option`(`deleted`);

-- CreateIndex
CREATE INDEX `Item_Genre_deleted_hidden_idx` ON `Item_Genre`(`deleted`, `hidden`);

-- CreateIndex
CREATE INDEX `Loss_Genre_is_deleted_idx` ON `Loss_Genre`(`is_deleted`);

-- CreateIndex
CREATE INDEX `Product_deleted_idx` ON `Product`(`deleted`);

-- CreateIndex
CREATE INDEX `Register_deleted_idx` ON `Register`(`deleted`);

-- CreateIndex
CREATE INDEX `Shipping_Method_deleted_idx` ON `Shipping_Method`(`deleted`);

-- CreateIndex
CREATE INDEX `Supplier_deleted_idx` ON `Supplier`(`deleted`);

-- CreateIndex
CREATE INDEX `Transaction_is_return_idx` ON `Transaction`(`is_return`);
