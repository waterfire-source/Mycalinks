-- DropForeignKey
ALTER TABLE `Transaction_Cart` DROP FOREIGN KEY `Transaction_Cart_reservation_reception_product_id_for_depos_fkey`;

-- DropForeignKey
ALTER TABLE `Transaction_Cart` DROP FOREIGN KEY `Transaction_Cart_reservation_reception_product_id_for_recei_fkey`;

-- DropIndex
DROP INDEX `Transaction_Cart_reservation_reception_product_id_for_deposi_idx` ON `Transaction_Cart`;

-- DropIndex
DROP INDEX `Transaction_Cart_reservation_reception_product_id_for_receiv_idx` ON `Transaction_Cart`;
