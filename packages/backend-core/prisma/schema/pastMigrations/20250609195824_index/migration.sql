-- DropForeignKey
ALTER TABLE `Product` DROP FOREIGN KEY `Product_item_id_fkey`;

-- DropForeignKey
ALTER TABLE `Product` DROP FOREIGN KEY `Product_store_id_fkey`;

-- DropIndex
DROP INDEX `Product_item_id_deleted_mycalinks_ec_enabled_actual_ec_sell__idx` ON `Product`;

-- DropIndex
DROP INDEX `Product_store_id_deleted_is_active_item_id_stock_number_idx` ON `Product`;
...
-- CreateIndex
CREATE INDEX `Product_store_id_deleted_is_active_item_id_idx` ON `Product`(`store_id`, `deleted`, `is_active`, `item_id`);

-- CreateIndex
CREATE INDEX `Product_item_id_deleted_mycalinks_ec_enabled_actual_ec_sell__idx` ON `Product`(`item_id`, `deleted`, `mycalinks_ec_enabled`, `actual_ec_sell_price`, `condition_option_id`, `ec_stock_number`);