/*
  ...
  - The values [O3_A_MINUS] on the enum `Item_Category_Condition_Option_handle` will be removed. If these variants are still used in the database, this will fail.
...
-- AlterTable
ALTER TABLE `Item_Category_Condition_Option` MODIFY `handle` ENUM('O1_S', 'O2_A', 'O3_FOR_PLAY', 'O4_B', 'O5_C', 'O6_D', 'O1_BRAND_NEW', 'O2_LIKE_NEW', 'O3_USED') NULL,
    MODIFY `deleted` TINYINT UNSIGNED NOT NULL DEFAULT false,
    MODIFY `created_at` TIMESTAMP(0) NOT NULL DEFAULT CURRENT_TIMESTAMP();
