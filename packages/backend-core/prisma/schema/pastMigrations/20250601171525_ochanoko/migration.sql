...
-- AlterTable
ALTER TABLE `Ec_Order_Cart_Store` ADD COLUMN `shipping_company_display_name` VARCHAR(191) NULL,
    ADD COLUMN `shipping_method_display_name` VARCHAR(191) NULL,
    MODIFY `code` VARCHAR(30) NOT NULL DEFAULT concat(lpad(hex(unix_timestamp(now(3)) * 1000), 12, '0'),substr(hex(random_bytes(2)), 2)),
