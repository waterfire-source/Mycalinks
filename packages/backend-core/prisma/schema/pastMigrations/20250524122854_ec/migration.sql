/*
  ...
  - You are about to drop the `Outbox_Product_Stock_History` table. If the table is not empty, all the data it contains will be lost.
...
-- AlterTable
ALTER TABLE `Transaction_Cart` ADD COLUMN `original_item_count` INTEGER NULL;

-- DropTable
DROP TABLE `Outbox_Product_Stock_History`;
