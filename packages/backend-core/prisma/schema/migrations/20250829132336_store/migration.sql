...
-- AlterTable
ALTER TABLE `Shipping_Method` ADD COLUMN `is_store_pickup` TINYINT UNSIGNED NOT NULL DEFAULT false,
...
-- CreateIndex
CREATE INDEX `Item_store_id_myca_item_id_order_number_id_idx` ON `Item`(`store_id`, `myca_item_id` DESC, `order_number` DESC, `id` DESC);
