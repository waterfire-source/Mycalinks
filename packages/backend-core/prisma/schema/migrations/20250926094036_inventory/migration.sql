-- DropForeignKey
ALTER TABLE `Inventory_Products` DROP FOREIGN KEY `Inventory_Products_wholesale_price_history_id_fkey`;

-- DropIndex
DROP INDEX `Inventory_Products_wholesale_price_history_id_fkey` ON `Inventory_Products`;
...
-- AlterTable
ALTER TABLE `Inventory_Products` ADD COLUMN `product_stock_history_id` INTEGER UNSIGNED NULL;
...
-- AddForeignKey
ALTER TABLE `Inventory_Products` ADD CONSTRAINT `Inventory_Products_wholesale_price_history_id_fkey` FOREIGN KEY (`wholesale_price_history_id`) REFERENCES `Product_Wholesale_Price_History`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Inventory_Products` ADD CONSTRAINT `Inventory_Products_product_stock_history_id_fkey` FOREIGN KEY (`product_stock_history_id`) REFERENCES `Product_Stock_History`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
