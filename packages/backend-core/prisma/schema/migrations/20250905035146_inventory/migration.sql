...
-- AlterTable
ALTER TABLE `Inventory_Products` ADD COLUMN `wholesale_price_history_id` INTEGER UNSIGNED NULL,
    ADD COLUMN `wholesale_price_injected` TINYINT UNSIGNED NULL;
...
-- AddForeignKey
ALTER TABLE `Inventory_Products` ADD CONSTRAINT `Inventory_Products_wholesale_price_history_id_fkey` FOREIGN KEY (`wholesale_price_history_id`) REFERENCES `Product_Wholesale_Price_History`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
