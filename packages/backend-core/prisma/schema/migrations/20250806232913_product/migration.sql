...
-- AlterTable
ALTER TABLE `Product` ADD COLUMN `allow_buy_price_auto_adjustment` TINYINT UNSIGNED NOT NULL DEFAULT true,
    ADD COLUMN `allow_sell_price_auto_adjustment` TINYINT UNSIGNED NOT NULL DEFAULT true,
...
-- 独自価格をリセットするかどうかの設定の引き継ぎ
UPDATE Product
SET allow_buy_price_auto_adjustment = arrow_auto_price_adjustment, allow_sell_price_auto_adjustment = arrow_auto_price_adjustment;