...
-- AlterTable
ALTER TABLE `Appraisal` ADD COLUMN `deleted` BOOLEAN NOT NULL DEFAULT false,
    ADD COLUMN `description` TEXT NULL,
    ADD COLUMN `handling_fee` INTEGER NOT NULL DEFAULT 0,
    ADD COLUMN `insurance_fee` INTEGER NOT NULL DEFAULT 0,
    ADD COLUMN `other_fee` INTEGER NOT NULL DEFAULT 0,
...
-- AlterTable
ALTER TABLE `Product_Stock_History` MODIFY `source_kind` ENUM('product', 'transaction_sell', 'transaction_buy', 'transaction_sell_return', 'transaction_buy_return', 'stocking', 'stocking_rollback', 'loss', 'loss_rollback', 'bundle', 'bundle_release', 'original_pack', 'original_pack_release', 'pack_opening', 'pack_opening_unregister', 'pack_opening_rollback', 'pack_opening_unregister_rollback', 'box_opening', 'box_create', 'carton_opening', 'carton_create', 'appraisal_create', 'appraisal_return', 'appraisal_cancel', 'transfer', 'ec_sell', 'ec_sell_return', 'consignment_create', 'consignment_return', 'store_shipment', 'store_shipment_rollback', 'location', 'location_release') NOT NULL,
