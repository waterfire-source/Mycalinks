...
-- AlterTable
ALTER TABLE `Purchase_Table` ADD COLUMN `display_on_app` TINYINT UNSIGNED NOT NULL DEFAULT false,
    ADD COLUMN `genre_handle` VARCHAR(20) NULL,
...
-- AlterTable
ALTER TABLE `Store` ADD COLUMN `purchase_table_push_notification_count` INTEGER NOT NULL DEFAULT 0,
    ADD COLUMN `purchase_table_push_notification_last_sent_at` TIMESTAMP(0) NULL,
