...
-- AlterTable
ALTER TABLE `Consignment_Client` ADD COLUMN `display_name_on_receipt` TINYINT UNSIGNED NOT NULL DEFAULT false,
...
-- AlterTable
ALTER TABLE `Store` ADD COLUMN `billing_source_address` VARCHAR(191) NULL,
    ADD COLUMN `billing_source_bank_account_name_ruby` VARCHAR(191) NULL,
    ADD COLUMN `billing_source_bank_account_number` VARCHAR(191) NULL,
    ADD COLUMN `billing_source_bank_account_type` VARCHAR(191) NULL,
    ADD COLUMN `billing_source_bank_branch_name` VARCHAR(191) NULL,
    ADD COLUMN `billing_source_bank_name` VARCHAR(191) NULL,
    ADD COLUMN `billing_source_corporation_name` VARCHAR(191) NULL,
    ADD COLUMN `billing_source_email` VARCHAR(191) NULL,
    ADD COLUMN `billing_source_phone_number` VARCHAR(191) NULL,
...
-- AddForeignKey
ALTER TABLE `Billing_Client` ADD CONSTRAINT `Billing_Client_store_id_fkey` FOREIGN KEY (`store_id`) REFERENCES `Store`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
