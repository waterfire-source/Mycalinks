/*
  ...
  - You are about to drop the column `unit_price` on the `Store_Shipment_Product` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `Store_Shipment_Product` DROP COLUMN `unit_price`;
