/*
  ...
  - A unique constraint covering the columns `[shopify_location_id]` on the table `Ec_Setting` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX `Ec_Setting_shopify_location_id_key` ON `Ec_Setting`(`shopify_location_id`);
