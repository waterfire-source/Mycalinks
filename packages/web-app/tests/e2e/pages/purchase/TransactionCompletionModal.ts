...
/**
 * Page object for the transaction completion modal
 */
export class TransactionCompletionModal {
  ...
  readonly labelButton: Locator;
  readonly finishButton: Locator;

  constructor(page: Page) {
    this.page = page;

    // Modal container - using data-testid when available
    ...
    this.labelButton = this.modalContainer.locator(
