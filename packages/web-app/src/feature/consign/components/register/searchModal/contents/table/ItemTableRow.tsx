...
import { ConsignmentProductRow } from '@/feature/consign/components/register/searchModal/contents/table/ProductRow';
...
export const ConsignmentItemTableRow: React.FC<Props> = ({
  item,
  handleAdd,
  selectedSpecialtyId,
}) => {
  ...
  const productMap = new Map<number, ConsignmentProductSearchType>();
