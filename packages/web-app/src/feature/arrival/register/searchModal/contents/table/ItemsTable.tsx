...
import { ArrivalItemTableRow } from '@/feature/arrival/register/searchModal/contents/table/ItemTableRow';
import {
  ArrivalItemType,
...
interface Props {
  ...
  allSearchResults: ArrivalItemType[];
  hasMore: boolean;
...
export const ArrivalItemsTable = ({
  searchState,
  setSearchState,
  allSearchResults,
  hasMore,
