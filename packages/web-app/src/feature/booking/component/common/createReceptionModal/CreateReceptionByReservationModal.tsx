...
import { Store, TransactionKind } from '@prisma/client';
...
export const CreateReceptionByReservationModal = ({
  open,
  onClose,
  store,
  customer,
  ...
  >([{ ...selectedReservation, itemCount: 1 }]);
  ...
  useEffect(() => {
    setSelectedReservations([{ ...selectedReservation, itemCount: 1 }]);
  }, [selectedReservation]);
